...
public class AgentController {
    ...
    @Operation(
            ...
            description = "Returns a paginated list of agents for operational use. "
                    ...
                    + "Accepts optional `available` and `locationId` filters that can be combined with each other and with `query`/`departmentId`. "
    ...
    public ResponseEntity<ApiResponse<PageResponse<AgentResponse>>> listAgents(
            ...
            @Parameter(description = "Filter by availability status") @RequestParam(required = false) Boolean available,
