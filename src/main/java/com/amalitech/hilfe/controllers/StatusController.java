...
public class StatusController {
    ...
    @Operation(summary = "List all statuses", description = "Returns every incident status configured in the system, including Unassigned, with no statuses omitted for any role.")
